package com.jularic.dominik.recreationassistant.data;
...
public class SunshinePreferences {
    ...
    private static final String DEFAULT_WEATHER_LOCATION = "Zagreb, HR";
    private static final double[] DEFAULT_WEATHER_COORDINATES =  {45.81, 15.98};
